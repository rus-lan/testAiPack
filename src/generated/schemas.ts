...
export const errorCodeSchema = z.enum(["E_REPO_TIMEOUT", "E_REPO_CLONE_FAILED", "E_PACK_INVALID_REF", "E_PACK_UNKNOWN_TYPE", "E_PACK_INSTALL_TIMEOUT", "E_PACK_INSTALL_FAILED", "E_HOME_SETUP_FAILED", "E_PREFLIGHT_TIMEOUT", "E_PREFLIGHT_FAILED", "E_PREFLIGHT_PACK_INVISIBLE", "E_RUN_TIMEOUT", "E_RUN_HANG_WATCHDOG", "E_RUN_CRASH", "E_VERIFY_TIMEOUT", "E_VERIFY_FAILED", "E_INSTALL_TIMEOUT", "E_INSTALL_FAILED", "E_TOTAL_TIMEOUT", "E_OOM", "E_DISK_FULL", "E_PORT_CONFLICT", "E_DOCKER_FAILED", "E_EXPORT_INVALID", "E_CONFIG_INVALID", "E_AUTH_MISSING", "E_MODEL_UNAVAILABLE", "E_RATE_LIMIT_EXHAUSTED"])
...
export const metricDeltaSchema = z.object({
    ...
    better: z.union([z.literal("better"), z.literal("worse"), z.literal("neutral"), z.literal("context-dependent")]),
  })
...
export const exportToolStateSchema = z.object({
    status: z.union([z.literal("pending"), z.literal("running"), z.literal("completed"), z.literal("error")]),
    input: z.unknown(),
...
export const exportPartSchema = z.union([exportTextPartSchema, exportReasoningPartSchema, exportToolPartSchema, exportStepStartPartSchema, exportStepFinishPartSchema])
...
export const homeIsolationErrorSchema = z.object({
    code: z.union([z.literal("E_HOME_SETUP_FAILED"), z.literal("E_AUTH_MISSING"), z.literal("E_DOCKER_FAILED"), z.literal("E_PACK_INSTALL_TIMEOUT"), z.literal("E_PACK_INSTALL_FAILED")]),
    message: z.string(),
    context: recordUnknownSchema.optional(),
  })
...
export const packInstallErrorSchema = z.object({
    code: z.union([z.literal("E_PACK_INVALID_REF"), z.literal("E_PACK_UNKNOWN_TYPE"), z.literal("E_INSTALL_TIMEOUT"), z.literal("E_INSTALL_FAILED")]),
    message: z.string(),
    packRef: z.string(),
    context: recordUnknownSchema.optional(),
  })
...
export const preflightErrorSchema = z.object({
    code: z.union([z.literal("E_PREFLIGHT_TIMEOUT"), z.literal("E_PREFLIGHT_FAILED"), z.literal("E_PREFLIGHT_PACK_INVISIBLE"), z.literal("E_AUTH_MISSING")]),
    phase: z.literal("preflight"),
    check: z.union([z.literal("opencode-launch"), z.literal("auth-ping"), z.literal("build-agent"), z.literal("pack-visibility"), z.literal("baseline-identical")]),
    side: sideSchema,
    message: z.string(),
    context: recordUnknownSchema.optional(),
  })
...
export const timelineEventTypeSchema = z.enum(["reasoning", "tool-call", "tool-result", "step-finish", "text"])
...
export const timelineEventSchema = z.object({
    ...
    status: z.union([z.literal("pending"), z.literal("running"), z.literal("completed"), z.literal("error")]).optional(),
  })
...
export const runSideErrorSchema = z.object({
    code: z.union([z.literal("E_RUN_TIMEOUT"), z.literal("E_RUN_HANG_WATCHDOG"), z.literal("E_RUN_CRASH"), z.literal("E_VERIFY_TIMEOUT"), z.literal("E_VERIFY_FAILED"), z.literal("E_RATE_LIMIT_EXHAUSTED"), z.literal("E_OOM"), z.literal("E_DISK_FULL"), z.literal("E_PORT_CONFLICT"), z.literal("E_EXPORT_INVALID"), z.literal("E_TOTAL_TIMEOUT")]),
    message: z.string(),
    side: sideSchema,
    runIndex: z.number().int(),
    context: recordUnknownSchema.optional(),
...
export const workspaceSetupErrorSchema = z.object({
    ...
    message: z.string(),
    reason: z.union([z.literal("already-exists"), z.literal("not-a-directory"), z.literal("mkdir-failed"), z.literal("write-failed")]).optional(),
